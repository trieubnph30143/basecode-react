...
const HomePage = () => {
  return (
    <div>
      <div>
        {/* Title */}
        <div className="flex justify-between  pt-32  bg-white">
          <h1 className="text-center text-2xl font-bold text-gray-800 ml-[210px] mb-[10px]">
            Products Client
            <hr />
          </h1>

          <div className=" mr-[210px] mb-[10px]">
            <Search />
          </div>
        </div>
        {/* Tab Menu */}
